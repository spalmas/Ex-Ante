...
We first need the predicted maize prices at market locations. We also need to bring the maize_price raster to 1km resolution by aggregating using a mean of the cells.

```{r, eval=FALSE}
maize_price <- rast("F:/Work/MaizePricePredictions/TZA/pred_maize_price1.tif") / 2292 #/2292 to convert to USD/kg
...
grump <- vect("F:/Work/grump-v1-settlement-points-rev01-shp/global_settlement_points_v1.01_TZA_CitiesAdded.shp") %>% 
  project("+proj=laea +lat_0=5 +lon_0=20 +x_0=0 +y_0=0 +ellps=WGS84 +units=m +no_defs")
...
writeRaster(maize_price_points_max,
