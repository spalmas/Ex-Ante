...
```{r}
pred_maize_price1 <- rast("F:/Work/MaizePricePredictions/TZA/pred_maize_price1.tif")
...
district_2013_vect <- terra::project(district_2013_vect, crs=crs(pred_maize_price1))

ward_2013_vect <- vect(ward_2013[,c("lon_modified", "lat_modified")],
                           crs = "+proj=longlat +datum=WGS84 +no_defs ")
ward_2013_vect <- terra::project(ward_2013_vect, crs=crs(pred_maize_price1))

local_2013_vect <- vect(local_2013[,c("lon_modified", "lat_modified")],
                           crs = "+proj=longlat +datum=WGS84 +no_defs ")
local_2013_vect <- terra::project(local_2013_vect, crs=crs(pred_maize_price1))

#extract values and add them to the tables
district_2013$pred_maize_price1 <- as.vector(extract(pred_maize_price1, district_2013_vect, drop=TRUE))
ward_2013$pred_maize_price1 <- as.vector(extract(pred_maize_price1, ward_2013_vect, drop=TRUE))
local_2013$pred_maize_price1 <- as.vector(extract(pred_maize_price1, local_2013_vect, drop=TRUE))

#correlation plots
plot_fitness(obs =district_2013$maipkg,
             pred=district_2013$pred_maize_price1,
             "District Fitness")

plot_fitness(obs =ward_2013$maipkg,
             pred=ward_2013$pred_maize_price1,
             "Ward Fitness")

plot_fitness(obs =local_2013$maipkg,
             pred=local_2013$pred_maize_price1,
             "Local Fitness")
