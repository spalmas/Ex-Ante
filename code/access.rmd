...
adm <- vect("../data/admin/gadm36_TZA_0.shp")
adm <- project(adm, crs=crs(tza_alt))
```
...
```{r plotRoads}
roads <- reagrodata::reagro_data("tza_roads")
...
```{r}
tza_lc <- reagrodata::reagro_data("TZA_globcover")
...
writeRaster(A, filename = "../results/tif/access/ccCost50k.tif", overwrite=TRUE)
