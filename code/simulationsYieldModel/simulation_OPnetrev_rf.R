...
for (AUE in AUES){
  ...
  OPnetrev <- read.table("data/soilprice_table.txt", header=TRUE, sep=" ")
  ...
  seasons <- OPnetrev %>% dplyr::select(contains("05.v3_sum_TZA")) %>% colnames()
  ...
  writeRaster(buildraster(OPnetrev$N_kgha, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_N_kgha_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$yield_mean, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_yield_mean_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$totfertcost, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_totfertcost_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_mean, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_mean_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_sd, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_sd_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_cv, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_cv_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$yield_mean_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_yield_mean_gainPerc_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$totfertcost_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_totfertcost_gainPerc_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_mean_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_mean_gainPerc_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$nue, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_nue_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$avcr, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_avcr_noMask.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$mvcr, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_mvcr_noMask.tif"), overwrite=TRUE)
  
  
  #### \\ Writing tables and rasters for analysis and visualization ####
  #This means removing non SPAM pixels from the table and rasters
  data.table::fwrite(OPnetrev, paste0("results/tables/OPnetrev_AUE", AUE, "_noMask.csv"))
  OPnetrev <- OPnetrev[!is.na(OPnetrev$spam2010V1r1_global_A_MAIZ_A_TZA),]
  data.table::fwrite(OPnetrev, paste0("results/tables/OPnetrev_AUE", AUE, ".csv"))
  
  writeRaster(buildraster(OPnetrev$N_kgha, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_N_kgha.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$yield_mean, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_yield_mean.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$totfertcost, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_totfertcost.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_mean, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_mean.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_sd, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_sd.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_cv, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_cv.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$yield_mean_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_yield_mean_gainPerc.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$totfertcost_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_totfertcost_gainPerc.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$netrev_mean_gainPerc, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_netrev_mean_gainPerc.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$nue, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_nue.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$avcr, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_avcr.tif"), overwrite=TRUE)
  writeRaster(buildraster(OPnetrev$mvcr, OPnetrev, template), filename=paste0("results/tif/OPnetrev_AUE", AUE, "_mvcr.tif"), overwrite=TRUE)
