...
writeRaster(buildraster(OPyield$yield_mean_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_yield_mean_gainPerc_noMask.tif", overwrite=TRUE)
writeRaster(buildraster(OPyield$totfertcost_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_totfertcost_gainPerc_noMask.tif", overwrite=TRUE)
writeRaster(buildraster(OPyield$netrev_mean_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_netrev_mean_gainPerc_noMask.tif", overwrite=TRUE)
...
writeRaster(buildraster(OPyield$yield_mean_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_yield_mean_gainPerc.tif", overwrite=TRUE)
writeRaster(buildraster(OPyield$totfertcost_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_totfertcost_gainPerc.tif", overwrite=TRUE)
writeRaster(buildraster(OPyield$netrev_mean_gainPerc, OPyield, template), filename="results/tif/TZA_OPyield_netrev_mean_gainPerc.tif", overwrite=TRUE)
